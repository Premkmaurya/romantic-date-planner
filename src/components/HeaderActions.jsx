  ...
  return (
    <header className="w-full px-6 py-4 flex justify-between items-center z-20">
      <div className="flex items-center gap-2 text-rose-500 font-serif font-bold text-xl">
        ...
        <span>რომანტიკული შეთავაზება</span>
      </div>
      ...
      <div className="flex items-center gap-2.5">
        <button
          ...
          title={musicPlaying ? "მსუბუქი მუსიკა გამორთვა" : "ფონის მუსიკა ჩართვა"}
        ...
        <button
          ...
          title={theme === 'dark' ? 'გაშიის რეჟიმზე გადასვლა' : 'ბნელ რეჟიმზე გადასვლა'}
